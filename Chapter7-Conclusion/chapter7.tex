...
We then evaluate the performances of our solver on problems relying heavily on the manifold formulation and show that it is superior to the classic approach in terms of convergence time and time spent per iteration.
...
We also presented an approach to compare the performances of different resolution methods on solving several types of posture generation problems, which could help develop strategies to tune our solver based on the problem at hand.
