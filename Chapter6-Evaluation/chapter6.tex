...
We first evaluated the influence of the formulation on manifolds on a problem making heavy use of them and showed that, as expected, this formulation outperforms the classical approach in terms of convergence times.
