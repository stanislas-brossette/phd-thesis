...
Tasks requires motions, which in turn can be defined by a set of continuous discreet postures. For a given snapshot of time (e.g. before initiating a motion), given a set of tasks specified by the user for a robot to satisfy, the questions that immediately comes to mind is: ``Is that set of tasks feasible?''.
