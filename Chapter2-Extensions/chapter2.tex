...
We denote $\text{dim(q)}$ and $\text{dim(y)}$ the dimensions of $q$ and $y$ respectively.
...
\begin{algorithmic}
  ...
  \frac{\partial f^G_i}{\partial x} = (\mathbf{I}^W \mathbf{M} - \mathbf{N})\begin{bmatrix}
      \mathbf{Jac_i^W} & \mathbf{0}_{6\times \text{dim(y)}}
        \end{bmatrix}
  +
  \begin{bmatrix}
    {{}^i\mathbf{R}_W} & -{{}^i\mathbf{R}_W}\widehat{{}^i\mathbf{t}_W} \\
  ...
  \begin{bmatrix}
    \mathbf{S_i} & \mathbf{0}_{6\times \text{dim(y)}}
  ...
  \State$\frac{\partial f^G_{pred(i)}}{\partial x} -=
  \begin{bmatrix}
    {\mathbf{R}^{x}_i}^T & \widehat{\mathbf{t}^{x}_i}{\mathbf{R}^{x}_i}^T \\
    \mathbf{0} & {\mathbf{R}^{x}_i}^T \\
  \end{bmatrix}
