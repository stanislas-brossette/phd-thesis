...
\begin{abstractpage}
  ...
  \begin{abstract}{english}
    ...
    Nous enrichissons la formulation de contraintes de contact par ajout de variables au probl\`eme d'optimisation, ce qui permet au solveur de d\'ecider automatiquement de la zone d'intersection entre deux polyg\^ones en contact ou encore de d\'ecider du lieu de contact sur une surface non plane.
