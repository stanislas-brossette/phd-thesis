...
In this thesis, we used the off-the-shelf solvers IPOPT~\cite{wachter:mathprog:2006} in the beginning. At a later stage we developped our own nonlinear solver, called {\tt PGSolver}, and then use it.
