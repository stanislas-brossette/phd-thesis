...
Those approaches are all computationally expensive and suffer from joint-space and workspace singularities~\cite{aristidou2009inverse}.
...
A different utilization of posture generation was presented in~\cite{stasse:humanoids:2007}, that deals with the problem of object reconstruction.
