...
The Wolfe Line-Search can be schematically described by algorithm:~\ref{alg:Wolfe} and illustrated by~\Figref{fig:Wolfe}.
...
A representation of the filter method is given in~\Figref{fig:Filter}
...
For example, with a single constraint, as illustrated in~\Figref{fig:TR_incompatible}.
