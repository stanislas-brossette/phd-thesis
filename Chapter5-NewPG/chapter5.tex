...
\end{itemize}
The custom geometric additional function can typically be used in the context of a planar contact to limit the position of $O_2$ to the inside of a polygon defined in the plane $(O_1,\vec{x_1},\vec{x_2})$.
...
The goal is to be able to reach the four corners of a panel of circuit breakers (in green on~\Figref{fig:getafe}) to activate them.
...
\subsection{Application to plane-sphere contact}
