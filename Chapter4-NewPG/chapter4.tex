...
In that case, the quantities involved in the constraint are invariant with the location of the contact point, and the equations are valid for any point of the surface.
...
When it comes to non-flat surfaces, the location of the frames used in eq:~\ref{eq:planar_contact} matters (in particular, the normal vector can vary for any point on the surface).
...
\caption{HRP4 carrying 2kg a cube.
