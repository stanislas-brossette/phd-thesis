...
For example in figure~\ref{fig:phimap}, $T_x\mathcal{M}$ is a 2-dimensional hyperplan embedded in $\mathbb{R}^3$.
...
And the logarithm is computes as follows (see~\cite{merlhiot:thesis:2009}):
\begin{align}
\begin{split}
