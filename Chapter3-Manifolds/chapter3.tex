...
This system is solved iteratively with updating $\bf z$ (but never changing $x$) with the solution of the previous system and updating the values in $c_i(x+\mathbf{z})$ until a satisfactory $\bf z$ is found.
