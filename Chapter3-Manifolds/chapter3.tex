...
$T_x\mathcal{M}$ can be identified with $\mathbb{R}^n$, but in some cases, it needs to be considered an a hyperplan of a higher dimensionality space.
For example in figure~\ref{fig:phimap} $T_x\mathcal{M}$ is a 2-dimensional hyperplan of $\mathbb{R}^3$.
