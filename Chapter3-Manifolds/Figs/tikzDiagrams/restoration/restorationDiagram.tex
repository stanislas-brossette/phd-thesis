...
\draw [arrow] (filterTest) -- node[anchor=east] {yes} (addFilter);
\draw [arrow] (filterTest) -- node[anchor=west] {no} (SOC);
\draw [arrow] (addFilter) -- (stepLimited);
\draw [arrow] (stepLimited) -- node[anchor=east] {yes} (increaseTR);
...
\draw [arrow] (forceAdd) -- (stepLimited);

\draw [arrow] (increaseTR) |-([shift={(-4mm,-3mm)}]increaseTR.south west)-- ([shift={(-22mm,3mm)}]feasibleTest.north west)-| (feasibleTest);
\draw [arrow] (stepLimited)  node[anchor=west, yshift=-1cm] {no} |-([shift={(-4mm,-3mm)}]increaseTR.south west)-- ([shift={(-22mm,3mm)}]feasibleTest.north west)-| (feasibleTest);
\draw [arrow] (tooSmallStep) node[anchor=east, shift={(-10mm,-4mm)}] {yes} |-([shift={(-56mm,-3mm)}]tooSmallStep.south west)-- ([shift={(-22mm,3mm)}]feasibleTest.north west)-| (feasibleTest);
\draw [arrow] (findSOC)  node[anchor=east, yshift=-1cm] {yes} |-([shift={(-4mm,-3mm)}]findSOC.south west) [xshift=1cm]-- ([shift={(2mm,3mm)}]addFilter.north east)-| (addFilter);
