...
\node (fail) [startstop, below of=smallStepTest, xshift=1.7cm, yshift=3mm] {\begin{tabular}{c}Too small step\\
Failure\end{tabular}};
\node (addToFilter) [process, below of=filterTest, xshift=2cm] {$x\leftarrow\varphi_x(z)$ Add to filter};
\node (limitedStep) [decision, below of=addToFilter, xshift=1cm, yshift=5mm] {Is step limited by trust region};
...
\draw [arrow] (forceAdd) |-([shift={(6mm,-3mm)}]forceAdd.south east)-- ([shift={(20mm,3mm)}]update.north east)-|(update);
\draw [arrow] (increaseTR) |-([shift={(-54mm,-7mm)}]increaseTR.south west)-- ([shift={(-19mm,3mm)}]update.north west)-| (update);
\draw [arrow] (limitedStep) |-([shift={(-54mm,-7mm)}]increaseTR.south west)-- ([shift={(-19mm,3mm)}]update.north west)-| (update);
\draw [arrow] (smallStepTest) |-([shift={(-54mm,-7mm)}]increaseTR.south west)-- ([shift={(-19mm,3mm)}]update.north west)-| (update);
